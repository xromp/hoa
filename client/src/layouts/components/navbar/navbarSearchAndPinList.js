...
const is_admin = asAdmin.includes(localStorage.selectedRoleVal)

export default {
  pages: {
    key: "title",
    data: [
      {title: "Notification",               url: "/notifications/new",                  icon: "BellIcon",           is_bookmarked: is_admin},
      {title: "Calendar",                   url: "/reservation/calendar/",              icon: "CalendarIcon",       is_bookmarked: true},
      {title: "Maintenance",                url: "/orders/new/",                        icon: "ToolIcon",           is_bookmarked: true},
      {title: "User",                       url: "/users/new",                          icon: "UserIcon",           is_bookmarked: is_admin},
      {title: "Bill",                       url: "/billings/new?type=ar",               icon: "DollarSignIcon",     is_bookmarked: is_admin},
