    ...
    <div class="vx-col sm:w-1/2 md:w-1/2 lg:w-2/5 m-4">
      <vx-card>
        ...
        <div class="count-down text-center">
          <countdown :time="new Date('07/15/2021 00:00:00').getTime() - new Date().getTime()">
        ...
        <div class="subscription">
          ...
          <div class="vx-card__title mb-6">
            <h4 class="text-center">You will be notified when this page is live</h4>
          </div>
          <div class="text-center">            
            <vs-button size="large" @click="home">Back to Home</vs-button>
          </div>
