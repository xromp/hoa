      ...
      <div class="vx-col md:w-1/2 w-full">
        ...
        <div class="vx-row ">
          <div class="vx-col w-full">         
            <vs-input class="w-full mt-4" label="Deposit" v-model="data_local.deposit_amount" type="number" name="deposit_amount" v-validate="'required'"/>
...
export default {
    ...
    return {
      ...
      data_local: {
        ...
        operational_days_json: [      
          { id:1, val: [], op_start_time:[], op_end_time:[], is_all_day:false, op_start_time_id:[], op_end_time_id:[] },
          { id:2, val: [], op_start_time:[], op_end_time:[], is_all_day:false, op_start_time_id:[], op_end_time_id:[] },
          { id:3, val: [], op_start_time:[], op_end_time:[], is_all_day:false, op_start_time_id:[], op_end_time_id:[] },
          { id:4, val: [], op_start_time:[], op_end_time:[], is_all_day:false, op_start_time_id:[], op_end_time_id:[] },
          { id:5, val: [], op_start_time:[], op_end_time:[], is_all_day:false, op_start_time_id:[], op_end_time_id:[] },
          { id:6, val: [], op_start_time:[], op_end_time:[], is_all_day:false, op_start_time_id:[], op_end_time_id:[] },
          { id:7, val: [], op_start_time:[], op_end_time:[], is_all_day:false, op_start_time_id:[], op_end_time_id:[] }
        ],
        buffer_time_unit: '',
        booking_limit: '',
        booking_limit_unit: ''
  ...
  computed: {
    validateForm () {
      return !this.errors.any() || this.data_local.deposit_amount !== ''
    }
  },
  methods: {
    remove(x, y) {
    ...
    addNewOpHours() {   
      ...
      let newOp = this.op_start_time + ' to ' + this.op_end_time
      let count = this.data_local.operational_days_json[this.selectedPopUpId]['val'].length 
    ...
    async save_changes () {
      try {
        if (!this.validateForm || this.hopErr) return

        this.$vs.loading()
        this.data_local.property_ref = localStorage.selectedPropertyRef
        this.data_local.operational_days_json = this.data_local.operational_days_json
        ...
        const amenity = await axios.post(`/amenity/save/-1`, {
        ...
        await axios.post(`/docs/table/save`, {
          ...
          path: `docs/amenity/gallery/${amenity['data']['result']['id']}`,
          folderId: 31
        })
    ...
    reset_data () {
      ...
      this.data_local['max_hours'] = ''
      this.data_local['amount'] = ''
      this.data_local['amenity_color'] = ''
      this.data_local['amenity_f_color'] = ''      
      this.data_local['buffer_time'] = ''
      this.data_local['available_from_time'] = ''
      this.data_local['available_to_time'] = ''
      this.data_local['deposit_amount'] = ''
      this.data_local['booking_message'] = ''
      this.data_local['terms_conditions'] = ''
      this.data_local['min_hours'] = ''
      this.data_local['is_all_day'] = ''
      this.data_local['operational_days_json'] = ''
      this.data_local['buffer_time_unit'] = ''
      this.data_local['booking_limit'] = ''
      this.data_local['booking_limit_unit'] = ''
