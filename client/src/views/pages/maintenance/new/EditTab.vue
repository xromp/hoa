      ...
      <div class="vx-col w-full md:w-1/2 mt-4">
        ...
        <div>
          <div class="vx-col w-full">
            <div class="mt-4">
              <label class="vs-input--label">Request Type</label>
              <v-select :options="optionRequestType" :reduce="name => name.id" label="name" v-validate="'required'" v-model="data_local.urgency" name="urgency"/>
...
export default {
  ...
  methods: {
    ...
    deleteImage(k) {
      ...
      console.log('this.rawFiles ', this.rawFiles)
    ...
    save_changes (loc) {
      ...
      new Promise(async(resolve, reject)  => {
        try {    
            ...
            .then(res => {    
              if(res['data'] != 'access_denied' && res['data'] != '') {
                ...
                if(res['data']['message'] == 'success') {
                  ...
                  if (loc=='a') {
                    setTimeout(() => {
                      window.location.href = "/maintenances/new";
                    },500)
                  } else {
            ...
            // save maintenance dt
            await axios.post(`/maintenance/dt/save/${this.resDataLocal.id}`, {
            ...
            await axios.post(`/docs/table/save`, {
              ...
              path: `docs/maintenance-request/gallery/${this.resDataLocal.id}`,
              folderId: 5
            })
