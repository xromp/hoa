  ...
  <div id="page-data-list">
    ...
    <div class="vx-card p-6">
      <div class="flex flex-wrap items-center">
        ...
        <!-- ADD NEW -->
        <div class="btn-add-new p-3 mb-4 mr-4 rounded-lg cursor-pointer flex items-center justify-center text-lg font-medium text-base text-primary border border-solid border-primary mt-4" @click="newRecord" v-if="showC">
...
export default {
  ...
  methods: {
    ...
    importUser () {
      this.$router.push("/property/import")
    },
    async loadData() {      
      ...
      if(result['data'] === 'access_denied') {
        ...
        this.listData = result['data'][0] === null ? 0 : result['data']
        this.loading = false
      }
    }
  },
  mounted () {
    ...
    EventBus.$on('property-list', result => {
      this.loadData()
    })
  },
  async created () {
