<template>
	<div class="vx-card p-6">
      ...
      <vs-popup classContent="popup-example" title="Add New Admin" :active.sync="popupActive2">
        <div class="vx-col w-full h-full">
          <div>
            <label class="vs-input--label">User Email</label>
            <v-select :options="optionUser" :reduce="email => email.id" label="email" v-validate="'required'" v-model="value1" name="value1" class="inputx"/>
          ...
          <div class="mt-6">            
            <vs-button class="mr-2" @click="newRecordProperty" color="primary" type="filled" :disabled="!validateForm">Add Existing</vs-button>
...
export default {
  ...
  methods: {
    ...
    async newRecordProperty() {
      ...
      await axios.post(`/property-manager/save/-1`, {              
        token: this.token,
        data: {
          user_id: this.value1,
