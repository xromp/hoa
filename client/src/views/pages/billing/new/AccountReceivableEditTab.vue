  ...
  <div id="data-edit-tab-info">
    ...
    <div class="vx-col w-1/2 approval-widget">
      <approval 
        ...
        :reference_id="0"
        :reference_no="''"
        :approval.sync="data_local.approval"
        :hideSubmit="true"
        type="bill"
        class="mb-4" />
    </div>
    ...
    <div class="vx-row">
      <div class="vx-col w-full">
        <div class="mt-8 flex flex-wrap items-center justify-end">
          ...
          <vs-button class="ml-4 mt-2" @click="submit('SAVE_ONLY')" :disabled="!validateForm">Save Only</vs-button>
  ...
  methods: {
    ...
    async submit(type) {
      ...
      try {
        ...
        if (!this.data_local.approval.length 
          && (type  === 'SAVE_AND_NEW' || type  === 'SAVE_AND_CLOSE')) {
          this.data_local.sendNotif = true;
          this.data_local.autoApproved = true;
        } else {
          this.data_local.sendNotif = false;
          this.data_local.autoApproved = false;
        }
